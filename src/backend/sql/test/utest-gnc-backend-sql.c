...
/* static void
test_gnc_sql_convert_timespec_to_string (Fixture *fixture, gconstpointer pData)
{
}*/
/* load_timespec
static void
...
// GNC_TEST_ADD (suitename, "gnc sql convert timespec to string", Fixture, NULL, test_gnc_sql_convert_timespec_to_string,  teardown);
