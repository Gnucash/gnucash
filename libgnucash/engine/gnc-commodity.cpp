...
static QuoteSourceList single_quote_sources =
{
    ...
    { false, SOURCE_SINGLE, C_("FQ Source", "Amsterdam Euronext eXchange, NL"), "aex" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Association of Mutual Funds in India"), "amfiindia" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Athens Exchange Group, GR"), "asegr" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Australian Stock Exchange, AU"), "asx" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Bloomberg"), "bloomberg" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Italian Stock Exchange, IT"), "borsa_italiana" },
    { false, SOURCE_SINGLE, C_("FQ Source", "BSE India, IN"), "bseindia" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Bucharest Stock Exchange, RO"), "bvb" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Colombo Stock Exchange, LK"), "cse" },
    { false, SOURCE_SINGLE, C_("FQ Source", "comdirect, DE"), "comdirect" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Consors Bank, DE"), "consorsbank" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Deka Investments, DE"), "deka" },
    { false, SOURCE_SINGLE, C_("FQ Source", "DWS, DE"), "dwsfunds" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Financial Times Funds service, GB"), "ftfunds" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Finanzpartner, DE"), "finanzpartner" },
    { false, SOURCE_SINGLE, C_("FQ Source", "FondsWeb, DE"), "fondsweb" },
    { false, SOURCE_SINGLE, C_("FQ Source", "GoldMoney precious metals"), "goldmoney" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Google Web, US Stocks"), "googleweb" },
    { false, SOURCE_SINGLE, C_("FQ Source", "IEX (Investors Exchange), US"), "iexcloud" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Market Watch"), "marketwatch" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Morningstar, AU"), "morningstarau" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Morningstar, CH"), "morningstarch" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Morningstar, GB"), "morningstaruk" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Morningstar, JP"), "morningstarjp" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Motley Fool"), "fool" },
    { false, SOURCE_SINGLE, C_("FQ Source", "New Zealand stock eXchange, NZ"), "nzx" },
    { false, SOURCE_SINGLE, C_("FQ Source", "NSE (National Stock Exchange), IN"), "nseindia" },
    { false, SOURCE_SINGLE, C_("FQ Source", "OnVista, DE"), "onvista"},
    { false, SOURCE_SINGLE, C_("FQ Source", "Paris Stock Exchange/Boursorama, FR"), "bourso" },
    { false, SOURCE_SINGLE, C_("FQ Source", "S-Investor, DE"), "sinvestor"},
    { false, SOURCE_SINGLE, C_("FQ Source", "Sharenet, ZA"), "za" },
    { false, SOURCE_SINGLE, C_("FQ Source", "SIX Swiss Exchange shares, CH"), "six" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Skandinaviska Enskilda Banken, SE"), "seb_funds" },
    { false, SOURCE_SINGLE, C_("FQ Source", "StockData"), "stockdata" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Stooq, PL"), "stooq" },
    { false, SOURCE_SINGLE, C_("FQ Source", "T. Rowe Price, US"), "troweprice" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Tesouro Direto bonds, BR"), "tesouro_direto" },
    { false, SOURCE_SINGLE, C_("FQ Source", "TIAA-CREF, US"), "tiaacref" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Toronto Stock eXchange, CA"), "tsx" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Tradegate, DE"), "tradegate" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Treasury Direct bonds, US"), "treasurydirect" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Twelve Data"), "twelvedata" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Union Investment, DE"), "unionfunds" },
    { false, SOURCE_SINGLE, C_("FQ Source", "US Govt. Thrift Savings Plan"), "tsp" },
    { false, SOURCE_SINGLE, C_("FQ Source", "XETRA, DE"), "xetra" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Yahoo as JSON"), "yahoo_json" },
    { false, SOURCE_SINGLE, C_("FQ Source", "Yahoo Web"), "yahooweb" },
    { false, SOURCE_SINGLE, C_("FQ Source", "YH Finance (FinanceAPI)"), "financeapi" },
};

static QuoteSourceList multiple_quote_sources =
{
    { false, SOURCE_MULTI, C_("FQ Source", "Australia (ASX)"), "australia" },
    { false, SOURCE_MULTI, C_("FQ Source", "Australia Funds (MorningstarAU)"), "aufunds" },
    { false, SOURCE_MULTI, C_("FQ Source", "Canada (Alphavantage, TMX)"), "canada" },
    { false, SOURCE_MULTI, C_("FQ Source", "Dutch (AEX)"), "dutch" },
    { false, SOURCE_MULTI, C_("FQ Source", "Europe (ASEGR, Bourso, …)"), "europe" },
    { false, SOURCE_MULTI, C_("FQ Source", "France (Bourso)"), "france" },
    { false, SOURCE_MULTI, C_("FQ Source", "Greece (ASEGR)"), "greece" },
    { false, SOURCE_MULTI, C_("FQ Source", "India (BSEIndia, NSEIndia)"), "india"},
    { false, SOURCE_MULTI, C_("FQ Source", "India Mutual (AMFI)"), "indiamutual" },
    { false, SOURCE_MULTI, C_("FQ Source", "Nasdaq (Alphavantage, FinanceAPI, …)"), "nasdaq" },
    { false, SOURCE_MULTI, C_("FQ Source", "NYSE (Alphavantage, FinanceAPI, …)"), "nyse" },
    { false, SOURCE_MULTI, C_("FQ Source", "Poland (Stooq)"), "poland" },
    { false, SOURCE_MULTI, C_("FQ Source", "Romania (BVB)"), "romania" },
    { false, SOURCE_MULTI, C_("FQ Source", "South Africa (Sharenet)"), "za" },
    { false, SOURCE_MULTI, C_("FQ Source", "U.K. Funds (FTfunds, MorningstarUK)"), "ukfunds" },
    { false, SOURCE_MULTI, C_("FQ Source", "USA (Alphavantage, FinanceAPI, …)"), "usa" },
};
