...
(define txf-income-catagories
  (list #(N000 "  none \\ Tax Report Only - No TXF Export" "" 0 #f)
	...
	#(N487 "< Sched B \\ Dividend income, non-taxable" "" 3 #t)
	#(N286 "^ Sched B \\ Dividend income, Ordinary" "" 3 #t)
	#(N287 "< Sched B \\ Interest income" "" 3 #t)
	#(N489 "< Sched B \\ Interest income, non-taxable" "" 3 #t)
	#(N492 "< Sched B \\ Interest income, OID bonds" "" 3 #t)
	#(N524 "< Sched B \\ Interest income, Seller-financed mortgage" "" 3 #t)
	...
	#(N488 "^ Sched D \\ Dividend income, capital gain distributions" "" 3 #t)
...
(define txf-expense-catagories
  (list #(N000 "  none \\ Tax Report Only - No TXF Export" "" 0 #f)
	...
	#(N613 "  F1040 \\ Fed tax withheld, RR retire, self" "" 1 #f)
	#(N614 "  F1040 \\ Fed tax withheld, RR retire, spouse" "" 1 #f)
	#(N611 "  F1040 \\ Fed tax withheld, Social Security, self" "" 1 #f)
	#(N612 "  F1040 \\ Fed tax withheld, Social Security, spouse" "" 1 #f)
	...
	#(N608 "  F1040 \\ Medical savings contribution, spouse" "" 1 #f)
	#(N607 "  F1040 \\ Medical savings contribution, self" "" 1 #f)
	#(N517 "  F1040 \\ SEP-IRA deduction, self" "" 1 #f)
	#(N518 "  F1040 \\ SEP-IRA deduction, spouse" "" 1 #f)
	...
	#(N401 "< F2441 \\ Qualifying child/dependent care expenses" "" 3 #f)
	...
	#(N462 "  W-2 \\ Social Security tax withheld, self" "" 1 #t)
