...
static GncDisplayItem gnc_plugin_page_register_display_items [] =
{
    /* File menu */
    {
...
{
    { "FilePrintAction", N_("_Print Cheques..."), TRUE, NULL },
    ...
    { "ReportsAccountReportAction", N_("Account Report"), TRUE,
       N_ ("Open a register report for this Account") },
    { "ReportsAcctTransReportAction", N_("Account Report - Single Transaction"), TRUE,
       N_ ("Open a register report for the selected Transaction") },
