...
(define-record-type <html-sankey>
  (make-html-sankey from-date to-date width height x-axis-style income-color expense-color asset-color liability-color equity-color fallback-color js-data)
  html-sankey?
