...
struct _acct_tree_defaults {
  ...
  {/* PRESENT */	TRUE,  GTK_JUSTIFY_RIGHT, "present",		"Present (Please add to translation later!)"},
  {/* PRESENT_REPORT */	TRUE,  GTK_JUSTIFY_RIGHT, "present_report",	"Present (Please add to translation later!)"},
  {/* BALANCE */	TRUE,  GTK_JUSTIFY_RIGHT, "balance",		N_("Balance")},
  {/* BALANCE_REPORT */	TRUE,  GTK_JUSTIFY_RIGHT, "balance_report",	N_("Balance")},
  {/* CLEARED */	TRUE,  GTK_JUSTIFY_RIGHT, "cleared",		"Cleared (Please add to translation later!)"},
  {/* CLEARED_REPORT */	TRUE,  GTK_JUSTIFY_RIGHT, "cleared_report",	"Cleared (Please add to translation later!)"},
  {/* RECNCLD */	TRUE,  GTK_JUSTIFY_RIGHT, "reconciled",		"Reconciled (Please add to translation later!)"},
  {/* RECNCLD_REPORT */	TRUE,  GTK_JUSTIFY_RIGHT, "reconciled_report",	"Reconciled (Please add to translation later!)"},
  {/* FUTURE_MIN */	TRUE,  GTK_JUSTIFY_RIGHT, "future_min",		"Future Minimum (Please add to translation later!)"},
  {/* FUT_MIN_REPORT */	TRUE,  GTK_JUSTIFY_RIGHT, "future_min_report",	"Future Minimum (Please add to translation later!)"},
