                         ...
                         gpointer user_data)
{
    ...
    menu_model = (GMenuModel *)gtk_builder_get_object (builder, "embeddedwin-menu");
 ...
 *  @param window_in A pointer to a generic window. */
static GHashTable *
gnc_embedded_window_get_display_hash_table (GncWindow *window)
{
    GncEmbeddedWindowPrivate *priv;
...
gnc_window_embedded_window_init (GncWindowIface *iface)
{
    ...
    iface->get_disp_hash_table = gnc_embedded_window_get_display_hash_table;
}
