...
CAIRO_URL="$GNOME_WIN32_DEPS_URL/cairo-1.4.0.zip"
CAIRO_DEV_URL="$GNOME_WIN32_DEPS_URL/cairo-dev-1.4.0.zip"
...
PANGO_URL="$GNOME_WIN32_URL/pango/1.14/pango-1.14.10.zip"
PANGO_DEV_URL="$GNOME_WIN32_URL/pango/1.14/pango-dev-1.14.10.zip"
