...
<xsl:include href="http://docbook.sourceforge.net/release/xsl/current/manpages/lists.xsl"/>
<xsl:include href="http://docbook.sourceforge.net/release/xsl/current/manpages/xref.xsl"/>
...
.TH "</xsl:text>
      ...
      <xsl:text> "Copyright 2004-2005 Neil Williams" "0.1.0" "CASHUTIL"&#10;</xsl:text>
      <xsl:apply-templates/>
      <xsl:text>&#10;</xsl:text>
