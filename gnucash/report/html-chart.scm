...
(define (gnc:html-chart-set-x-axis-label! chart label)
  (gnc:html-chart-set! chart '(options scales x title display) (and label #t))
...
(define (gnc:html-chart-set-grid?! chart grid?)
  (gnc:html-chart-set! chart '(options scales x grid color) (and grid? 'lightgrey))
  (gnc:html-chart-set! chart '(options scales y grid color) (and grid? 'lightgrey)))

(define (gnc:html-chart-set-y-axis-label! chart label)
  (gnc:html-chart-set! chart '(options scales y title display) (and label #t))
...
Chart.defaults.plugins.title.font.size = parseInt (titleStyle.fontSize);
Chart.defaults.plugins.title.font.family = titleStyle.fontFamily;
Chart.defaults.plugins.title.font.style = titleStyle.fontStyle;
