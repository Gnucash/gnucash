...
option like this.") 
    ...
    ;; This is a Report Title option and the default value is
    ;; "Report Title Default".
    (add-option
     (gnc:make-string-option
      (N_ "Testing") (N_ "Report Title")
      "c" (N_ "Title for this report.") (N_ "Report Title Default")))
...
(define (options-example-renderer report-obj)
  ...
  ;; be generated by the options generator above: variable, op, section,
  ;; default. Tabs options are ordered by sorting key.
  (let ((bool-val     (op-value "Tab B"   "Boolean Option"))
        ...
        (report-title (op-value "Testing" "Report Title"))
